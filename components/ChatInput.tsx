...
function ChatInput({ chatId }: ChatInputProps) {
  ...
  const handlePromptSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    const modelBasedPrompts = gptMessagesHistory;
  ...
  return (
    <div className="bg-gray-700/50 text-gray-400 rounded-lg text-sm mx-2 my-3 hover:bg-gray-600/50">
      <form
        className="p-5 space-x-5 flex justify-between"
      ...
      >
        ...
        <button
          ...
          type="submit"
          className="p-1 rounded hover:bg-[#11A37F] hover:text-white disabled:bg-gray-500 disabled:text-gray-700"
        >
